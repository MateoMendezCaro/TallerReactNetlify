...
import arrozImg from '../assets/arroz-con-leche_1.png';
import arrozImg from '../assets/arroz-con-leche_2.png';
import arrozImg from '../assets/arroz-con-leche_3.png';
...
const RecetaArrozConLeche = () => {
  return (
    <div className="receta-container">
      <h1>Arroz con Leche (en Olla Lenta)</h1>
      <img src={arrozImg} alt="Arroz con leche" className="receta-img" />
